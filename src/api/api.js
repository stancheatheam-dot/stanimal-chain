...
function createAPI(blockchain, p2p) {
  ...
  app.get('/chain/validate', (req, res) => {
    ...
    res.json({ valid, blocks: blockchain.chain.length });
  });
  ...
  app.get('/validators', (req, res) => {
    res.json(Object.fromEntries(blockchain.validators));
  });
  ...
  app.get('/products', (req, res) => {
    res.json(Object.fromEntries(blockchain.products));
  });
  ...
  app.get('/governance', (req, res) => {
    res.json(Object.fromEntries(blockchain.proposals));
  });
